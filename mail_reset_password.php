...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['email'])) {
    ...
    $updateSql = "UPDATE userdetails SET reset_code = '$reset_code' WHERE email = '$email'";
    ...
    if ($conn->query($updateSql) === TRUE) {
        ...
        <a href='http://localhost/product/reset_password.php?email=$email&reset_code=$reset_code'>Reset</a>";
