...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['post_id'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            $commentsSql = $conn->prepare("SELECT live_comment.*, userdetails.name AS username FROM live_comment INNER JOIN userdetails ON live_comment.userid = userdetails.id WHERE liveid = ?");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_comment'])) {
    ...
    if ($deleteSql->execute()) {
        ...
        header("Location: manage_live_comment.php");
        exit();
    } else {
                    ...
                    <div class="col-md-6">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form action="delete_live_comment.php" method="post">
